...
options = Options()
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Перед взаимодействием с браузером дожидаемся загрузки только DOM элементов.
# Если нужно взаимодействовать например с картинкой то возможно, что элемент не
# будет найден так как еще не прогрузился.
options.page_load_strategy = 'eager'
# Перед взаимодействием с браузером дожидаемся пока прогрузиться все,
# (DOM, скрипты, картинки, ...) эту стратегию selenium использует по умолчанию.
